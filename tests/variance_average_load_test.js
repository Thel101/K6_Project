...
export default function () {
  ...
  const authenticated_res = http.get(`${BASE_URL}/companies`, { headers: headers });
  ...
  const companyDetail = http.get(`${BASE_URL}/employees?company_id=TEST300525`, { headers: headers });
  check(companyDetail, {
...
export function handleSummary(data){
  return{
      "../reports/variance_avg_loadtest.html": htmlReport(data, { title: "Variance Tool Protocol Performance Test Report" }),
